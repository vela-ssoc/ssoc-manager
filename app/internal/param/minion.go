...
type MinionSummary struct {
	...
	HeartbeatAt time.Time          `json:"heartbeat_at" gorm:"column:heartbeat_at"`
...
type MinionDetail struct {
	...
	IBu           string             `json:"ibu"            gorm:"column:ibu"`
	IDC           string             `json:"idc"            gorm:"column:idc"`
	ManualNotes   model.FieldValues  `json:"manual_notes"   gorm:"column:manual_notes;serializer:json"`
